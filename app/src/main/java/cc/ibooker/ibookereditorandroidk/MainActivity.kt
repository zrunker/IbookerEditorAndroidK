...
class MainActivity : AppCompatActivity() {
    private var ibookerEditorView: IbookerEditorView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ibookerEditorView!!.ibookerEditorVpView?.editView?.ibookerEd?.setText("[链接描述](http://ips.ifeng.com/video19.ifeng.com/video09/2018/09/28/p2749834-102-998769-221938.mp4?ifsign=1&vid=2f24cc82-9236-4289-adcc-5e34ae569cc8&uid=1516537011039_hyemhv7718&from=weMedia_pc&pver=weMediaHTML5Player_v1.0.0&sver=&se=%E9%A3%9E%E7%A2%9F%E8%AF%B4&cat=8622&ptype=8622&platform=pc&sourceType=h5&dt=1538135880000&gid=SLTFYWYkO4jp&sign=16536514b3d291920ac6253872661e9c&tm=1538206173419)\n" +
                "                   " +
