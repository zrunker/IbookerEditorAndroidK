...
//        ibookerEditorView.ibookerEditorTopView?.backImg?.visibility = View.VISIBLE
        ...
        // 设置书客编辑器中间布局相关属性
        ibookerEditorView.ibookerEditorVpView?.editView?.setIbookerEdHint("书客编辑器")
...
//        ibookerEditorView.ibookerEditorToolView?.emojiIBtn?.visibility = View.GONE
        ...
        ibookerEditorView.ibookerEditorVpView?.preView?.ibookerEditorWebView!!.setIbookerEditorImgPreviewListener(object : IbookerEditorWebView.IbookerEditorImgPreviewListener {
